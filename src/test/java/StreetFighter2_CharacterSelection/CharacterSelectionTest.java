...
public class CharacterSelectionTest {
    ...
    public void shouldWorkWithNoMoves() {
        ...
        assertEquals(solution, CharacterSelection.streetFighterSelection(fighters, new int[]{0,0}, new String[]{}));
    }
    ...
    public void shouldWorkWithFewMoves(){
        ...
        assertEquals(solution, CharacterSelection.streetFighterSelection(fighters, new int[] {0,0}, moves));
    }
